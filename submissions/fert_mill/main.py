"""care_mill labor that treats fertilizer as a cash crop.

The catalog in scripts/quant_catalog.py has no town sink for fertilizer.
Holding it never raises the quote. Collect every day, sell every turn
while the quote is at least $20. Premium goods still follow care_mill.
"""
...
def _sell_qty(
    ...
    if item == "FERTILIZER":
        # No town sink. Scipy's search sat at a floor of about $18. $40
