"""Stage policy: grow a feed bridge, then one cared herd matched to shop drain.

Days 0–2 only hire and grow wheat. From day 3 the agent locks a single
species (cow, sheep, or goose) from shop demand. Workers feed, then care,
then harvest. Fertilizer is sold only to finish paying for that herd.
"""
