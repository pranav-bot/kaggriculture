"""Market Velocity: adaptive crops with aggressive, cash-safe throughput."""
...
class MarketVelocityController(ActionController):
    def __init__(self):
        super().__init__(
    ...
    def plan_market_actions(self, farm, private, market, current_day):
        ...
        return super().plan_market_actions(farm, private, market, current_day)
...
controller = MarketVelocityController()
