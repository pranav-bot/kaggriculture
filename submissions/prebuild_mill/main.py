"""Stage policy: pastures before the shops open, then the care_mill sell rule.

Days 0–2 hire, buy a wheat stock, and build pastures. There is no feed crop,
so day 3 can place animals instead of watering wheat. Selling still holds
product above base until the shed is tight. Selling early was tried in
cashflow_mill and gave the premium away.
"""
...
def _market(obs: Mapping[str, Any], scan: Mapping[str, Any], animal: str, demand: Mapping[str, float]) -> List[List[Any]]:
    ...
    wheat_floor = 36 if live == 0 else live * 2 + 6
