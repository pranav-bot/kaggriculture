"""compound_implementation — feed-safe compound growth from velocity_mill.

This variant preserves velocity_mill's feed-safe wheat opening and task planner,
then adds a guarded day-6 NE expansion and a non-displacing liquidity crop.
"""
